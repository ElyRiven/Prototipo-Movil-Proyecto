...
class ActiveTripPlaceScreen extends StatefulWidget {
  final int userId;
  final String csrfToken;
  final Place? place;
  const ActiveTripPlaceScreen(
      {super.key, required this.userId, required this.csrfToken, this.place});

  @override
  State<ActiveTripPlaceScreen> createState() => _ActiveTripPlaceScreenState();
}

class _ActiveTripPlaceScreenState extends State<ActiveTripPlaceScreen> {
